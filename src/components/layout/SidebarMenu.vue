  ...
  <ul class="sidebar-menu">
    ...
    <router-link tag="li" class="pageLink" to="/">
      <a>
        ...
        <span class="page">Indicadores</span>
      </a>
    </router-link>
    <router-link tag="li" class="pageLink" to="/receitas">
      <a>
        <i class="fa fa-money"></i>
        <span class="page">Quanto eu recebi</span>
      </a>
    </router-link>

    <!--<li class="header">ME</li>-->
    <router-link tag="li" class="pageLink" to="/despesas">
      <a>
        <i class="fa fa-usd"></i>
        <span class="page">Custo dos produtos</span>
      </a>
    </router-link>
    <router-link tag="li" class="pageLink" to="/custofixo">
      <a>
        <i class="fa fa-calendar-check-o"></i>
        <span class="page">Custos mensais</span>
      </a>
    </router-link>
    <router-link tag="li" class="pageLink" to="/impostos">
      <a>
        <i class="fa fa-minus"></i>
        <span class="page">Impostos</span>
      </a>
    </router-link>
    <router-link tag="li" class="pageLink" to="/dre">
      <a>
        <i class="fa fa-list"></i>
        <span class="page">Meu Resultado</span>
      </a>
    </router-link>
<!--    <li class="treeview">
      <a href="#">
